...
asmlinkage long sys_write_crypt(unsigned int fd, const char __user *buf, size_t count);
asmlinkage long sys_read_crypt(unsigned int fd, char __user *buf, size_t count);
